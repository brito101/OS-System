...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><i class="fas fa-fw fa-truck"></i> Ficha de Fornecedor</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('admin.home') }}">Home</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('admin.providers.index') }}">Fornecedores</a></li>
                        <li class="breadcrumb-item active">Ficha de Fornecedor</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="card">
                        ...
                        <form>
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex flex-wrap justify-content-between">
                                    <div class="col-12 col-md-6 form-group px-0 pr-md-2">
                                        ...
                                        <input type="text" class="form-control bg-white" id="social_name"
                                            name="social_name" value="{{ $provider->social_name }}" disabled>
                                    </div>
                                    <div class="col-12 col-md-6 form-group px-0 pl-md-2">
                                        <label for="alias_name">Nome Fantasia</label>
                                        <input type="text" class="form-control bg-white" id="alias_name"
                                            name="alias_name" value="{{ $provider->alias_name }}" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex flex-wrap justify-content-between">
                                    <div class="col-12 col-md-4 form-group px-0 pr-md-2">
                                        ...
                                        <input type="text" class="form-control bg-white" id="document_company"
                                            name="document_company" value="{{ $provider->document_company }}" disabled>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-4 form-group px-0 px-md-2">
                                        ...
                                        <input type="text" class="form-control bg-white" id="document_company_secondary"
                                            ...
                                            value="{{ $provider->document_company_secondary }}" disabled>
                                    </div>
                                ...
                                <div class="d-flex flex-wrap justify-content-between">
                                    <div class="col-12 form-group px-0">
                                        ...
                                        <input type="text" class="form-control bg-white" id="payment_conditions"
                                            name="payment_conditions" value="{{ $provider->payment_conditions }}"
                                            disabled>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex flex-wrap justify-content-between">
                                    <div class="col-12 col-md-6 form-group px-0 pr-md-2">
                                        ...
                                        <input type="text" class="form-control bg-white" id="average_delivery_time"
                                            name="average_delivery_time" value="{{ $provider->average_delivery_time }}"
                                            disabled>
                                    </div>

                                    <div class="col-12 col-md-6 form-group px-0 pl-md-2">
                                        <label for="discounts">Condições de Desconto</label>
                                        <input type="text" class="form-control bg-white" id="discounts"
                                            name="discounts" value="{{ $provider->discounts }}" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex flex-wrap justify-content-between">
                                    ...
                                    <div class="col-12 col-md-6 form-group px-0 pl-md-2">
                                        ...
                                        <input type="text" class="form-control bg-white" id="promotion_funds"
                                            name="promotion_funds" value="{{ $provider->promotion_funds }}" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex flex-wrap justify-content-between">
                                    <div class="col-12 col-md-6 form-group px-0 pr-md-2">
                                        ...
                                        <input type="text" class="form-control bg-white" id="technical_assistance"
                                            ...
                                            value="{{ $provider->technical_assistance }}"disabled>
                                    </div>

                                    <div class="col-12 col-md-6 form-group px-0 pl-md-2">
                                        <label for="total_purchases_previous_year">Total adquirido no ano anterior</label>
                                        <input type="text" class="form-control bg-white"
                                            id="total_purchases_previous_year" name="total_purchases_previous_year"
                                            value="{{ $provider->total_purchases_previous_year }}" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex flex-wrap justify-content-between">
                                    <div class="col-12 col-md-6 form-group px-0 pr-md-2">
                                        ...
                                        <input type="tel" class="form-control bg-white" id="zipcode"
                                            name="zipcode" value="{{ $provider->zipcode }}" disabled>
                                    </div>
                                    <div class="col-12 col-md-6 form-group px-0 pl-md-2">
                                        <label for="street">Rua</label>
                                        <input type="text" class="form-control bg-white" id="street"
                                            placeholder="Rua" name="street" value="{{ $provider->street }}" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex flex-wrap justify-content-between">
                                    <div class="col-12 col-md-6 form-group px-0 pr-md-2">
                                        ...
                                        <input type="text" class="form-control bg-white" id="number"
                                            name="number" value="{{ $provider->number }}" disabled>
                                    </div>
                                    <div class="col-12 col-md-6 form-group px-0 pl-md-2">
                                        <label for="complement">Complemento</label>
                                        <input type="text" class="form-control bg-white" id="complement"
                                            name="complement" value="{{ $provider->complement }}" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex flex-wrap justify-content-between">
                                    <div class="col-12 col-md-6 form-group px-0 pr-md-2">
                                        ...
                                        <input type="text" class="form-control bg-white" id="neighborhood"
                                            name="neighborhood" value="{{ $provider->neighborhood }}" disabled>
                                    </div>
                                    <div class="col-12 col-md-6 form-group px-0 pl-md-2">
                                        <label for="city">Cidade</label>
                                        <input type="text" class="form-control bg-white" id="city"
                                            name="city" value="{{ $provider->city }}" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex flex-wrap justify-content-between">
                                    <div class="col-12 col-md-6 form-group px-0 pr-md-2">
                                        ...
                                        <input type="text" class="form-control bg-white" id="state"
                                            name="state" value="{{ $provider->state }}" disabled>
                                    </div>

                                    @if ($provider->coverage)
                                        <div class="col-12 col-md-6 form-group px-0 pl-md-2">
                                            <label for="coverage">Cobertura</label>
                                            <input type="text" class="form-control bg-white" id="coverage"
                                                name="coverage"
                            ...
                            <div class="card-footer">
                                <a href="{{ route('admin.providers.pdf', ['id' => $provider->id]) }}" target="_blank"
