                    ...
                    <div class="d-flex flex-wrap justify-content-between px-0">
                        <div class="col-12 col-sm-6 col-md-4 px-0 pr-md-2">
                            <div class="info-box mb-3">
                                ...
                                <div class="info-box-content">
                                    <span class="info-box-text">Ordens de Compra Executadas</span>
                                    <span class="info-box-number">{{ $exec }}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-6 col-md-4 px-0 px-md-2">
                            <div class="info-box mb-3">
                                ...
                                <div class="info-box-content">
                                    <span class="info-box-text">Ordens de Compra Não Executadas</span>
                                    <span class="info-box-number">{{ $unexec }}</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card">
                        ...
                        @php
                            ...
                            $config = [
                                ...
                                'columns' => [['data' => 'id', 'name' => 'id'], ['data' => 'author', 'name' => 'author', 'visible' => false],
                                ['data' => 'subsidiary', 'name' => 'subsidiary', 'visible' => false], ['data' => 'number_series', 'name' => 'number_series'],
                                ['data' => 'date_pt', 'name' => 'date'], ['data' => 'date_pt', 'name' => 'date_pt', 'visible' => false],
                                ['data' => 'job', 'name' => 'job'], ['data' => 'requester', 'name' => 'requester'],
                                ['data' => 'forecast_pt', 'name' => 'forecast'],
                                ['data' => 'forecast_pt', 'name' => 'forecast_pt', 'visible' => false],
                                ['data' => 'value', 'name' => 'value'], ['data' => 'status', 'name' => 'status', 'visible' => false], ['data' => 'btnStatus', 'name' => 'status'], ['data' => 'action', 'name' => 'action', 'orderable' => false, 'searchable' => false]],
                        ...
                        <div class="card-body">
                            <x-adminlte-datatable id="table1" :heads="$heads" :heads="$heads" :config="$config"
                                striped hoverable beautify with-footer="purchase" />
                        </div>
                    </div>
                </div>
            </div>
