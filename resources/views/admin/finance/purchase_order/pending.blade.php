...
@section('title', '- Financeiro: Ordens de Compra Pendentes')
...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><i class="fas fa-fw fa-cart-plus"></i> Ordens de Compra Pendentes</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('admin.home') }}">Home</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('admin.finance-purchase-orders.index') }}">Ordens de Compra</a></li>
                        <li class="breadcrumb-item active">Ordens de Compra Pendentes</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex flex-wrap justify-content-between col-12 align-content-center">
                                <h3 class="card-title align-self-center">Ordens de Compra Cadastradas Pendentes</h3>
                        ...
                        @php
                            ...
                            $config = [
                                'order' => [[0, 'desc']],
                                'ajax' => url('/admin/finance-purchase-orders-pending'),
                                'columns' => [['data' => 'id', 'name' => 'id'],
                                ['data' => 'author', 'name' => 'author', 'visible' => false],
                                ['data' => 'subsidiary', 'name' => 'subsidiary', 'visible' => false],
                                ['data' => 'number_series', 'name' => 'number_series'], ['data' => 'date_pt', 'name' => 'date'],
                                ['data' => 'date_pt', 'name' => 'date_pt', 'visible' => false], ['data' => 'job', 'name' => 'job'],
                                ['data' => 'requester', 'name' => 'requester'], ['data' => 'forecast_pt', 'name' => 'forecast'],
                                ['data' => 'forecast_pt', 'name' => 'forecast_pt', 'visible' => false], ['data' => 'value', 'name' => 'value'], ['data' => 'status', 'name' => 'status', 'visible' => false], ['data' => 'btnStatus', 'name' => 'status'], ['data' => 'action', 'name' => 'action', 'orderable' => false, 'searchable' => false]],
