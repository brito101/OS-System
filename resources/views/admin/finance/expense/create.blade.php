...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><i class="fas fa-fw fa-minus"></i><i class="fas fa-fw fa-money-bill"></i> Nova Despesa</h1>
                </div>
                <div class="col-sm-6">
                                ...
                                <div class="d-flex flex-wrap justify-content-between">
                                    <div class="col-12 col-md-6 form-group px-0 pr-md-2">
                                        ...
                                        <input type="text" class="form-control" id="description"
                                            placeholder="Descrição da despesa" name="description"
                                ...
                                <div class="d-flex flex-wrap justify-content-start">
                                    <div class="col-12 col-md-6 form-group px-0 pr-md-2 mb-0">
                                        ...
                                        <x-adminlte-select2 name="purchase_mode">
                                            <option {{ old('purchase_mode') == 'boleto' ? 'selected' : '' }}
                                                value="boleto">
                                                Boleto
                                            </option>
                                            <option {{ old('purchase_mode') == 'cartão de crédito' ? 'selected' : '' }}
                                                value="cartão de crédito">
                                                Cartão de Crédito
                                            </option>
                                            <option {{ old('purchase_mode') == 'dinheiro' ? 'selected' : '' }}
                                                value="dinheiro">
                                                Dinheiro
                                            </option>
                                            <option {{ old('purchase_mode') == 'PIX' ? 'selected' : '' }} value="PIX">
                                                PIX
                                            </option>
                                            <option {{ old('purchase_mode') == 'transferência' ? 'selected' : '' }}
                                                value="transferência">
                                                Transferência
                                            </option>
                                        </x-adminlte-select2>
                                ...
                                <div class="d-flex flex-wrap justify-content-between">
                                    <div class="col-12 col-md-6 form-group px-0 pr-md-2 mb-0">
                                        ...
                                        <x-adminlte-select2 name="provider_id">
                                            <option {{ old('provider_id') == null ? 'selected' : '' }} value="">
                                                Nenhum</option>
