...
@section('title', '- Financeiro: Despesas Pendentes')
...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><i class="fas fa-fw fa-minus"></i><i class="fas fa-fw fa-money-bill"></i> Despesas Pendentes</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('admin.home') }}">Home</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('admin.finance-expenses.index') }}">Despesas</a></li>
                        <li class="breadcrumb-item active">Despesas Pendentes</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex flex-wrap justify-content-between col-12 align-content-center">
                                <h3 class="card-title align-self-center">Despesas Pendentes Cadastradas</h3>
                                @can('Criar Despesas')
                        ...
                        @php
                            ...
                            $config = [
                                'order' => [[0, 'desc']],
                                'ajax' => url('/admin/finance-expenses-pending'),
