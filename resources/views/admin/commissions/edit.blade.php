...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><i class="fas fa-fw fa-coins"></i> Editar Comissão #{{ $commission->id }}</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('admin.home') }}">Home</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('admin.commissions.index') }}">Comissões</a></li>
                        <li class="breadcrumb-item active">Editar Comissão</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <form method="POST"
                            action="{{ route('admin.commissions.update', ['commission' => $commission->id]) }}">
                            @method('PUT')
                            @csrf
                                ...
                                <div class="d-flex flex-wrap justify-content-between">
                                    <div class="col-12 col-md-6 form-group px-0 pr-md-2 mb-0">
                                        ...
                                        <x-adminlte-select2 name="seller_id" required>
                                            @foreach ($sellers as $seller)
                                                <option
                                                    {{ old('seller_id') == $seller->id ? 'selected' : ($commission->seller_id == $seller->id ? 'selected' : '') }}
                                    ...
                                    <div class="col-12 col-md-6 form-group px-0 pl-md-2">
                                        ...
                                        <input type="text" class="form-control" id="product"
                                            placeholder="Descrição do Produto" name="product"
                                            value="{{ old('product') ?? $commission->product }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex flex-wrap justify-content-between">
                                    <div class="col-12 form-group px-0">
                                        ...
                                        <input type="text" class="form-control" id="job"
                                            ...
                                            value="{{ old('job') ?? $commission->job }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex flex-wrap justify-content-between">
                                    <div class="col-12 col-md-4 form-group px-0 pr-md-2">
                                        ...
                                        <input type="text" class="form-control money_format_2" id="job_value"
                                            placeholder="Descrição da Obra" name="job_value"
                                            value="{{ old('job_value') ?? $commission->job_value }}" required
                                            onchange="calc()">
                                    </div>
                                    ...
                                    <div class="col-12 col-md-4 form-group px-0 pl-md-2">
                                        ...
                                        <input type="text" class="form-control money_format_2" id="total_value"
                                            ...
                                            value="{{ old('total_value') ?? $commission->total_value }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex flex-wrap justify-content-between">
                                    <div class="col-12 col-md-4 form-group px-0 pr-md-2">
                                        ...
                                        <input type="text" class="form-control date" id="due_date"
                                            ...
                                            value="{{ old('due_date') ?? $commission->due_date }}" required>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-4 form-group px-0 px-md-2 mb-0">
                                        ...
                                        <x-adminlte-select2 name="status">
                                            <option
                                                {{ old('status') == 'pendente' ? 'selected' : ($commission->status == 'pendente' ? 'selected' : '') }}
                                                value="pendente">
                                                Pendente
                                            </option>
                                            <option
                                                {{ old('status') == 'pago' ? 'selected' : ($commission->status == 'pago' ? 'selected' : '') }}
                                                value="pago">
                                                Pago
                                            </option>
                                        </x-adminlte-select2>
                                    ...
                                    <div class="col-12 col-md-4 form-group px-0 pl-md-2 mb-0">
                                        ...
                                        <x-adminlte-select2 name="subsidiary_id" required>
                                            @foreach ($subsidiaries as $subsidiary)
                                                <option
                                                    {{ old('subsidiary_id') == $subsidiary->id ? 'selected' : ($commission->subsidiary_id == $subsidiary->id ? 'selected' : '') }}
