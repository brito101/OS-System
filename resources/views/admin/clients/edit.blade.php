                                ...
                                <div class="d-flex flex-wrap justify-content-start">
                                    ...
                                    <div class="col-12 col-md-3 form-group px-0 px-md-2">
                                        ...
                                        <input type="number" class="form-control" id="blocks" name="blocks"
                                            min="0" value="{{ old('blocks') ?? $client->blocks }}">
                                    </div>
                                    <div class="col-12 col-md-3 form-group px-0 px-md-2">
                                ...
                                <div class="d-flex flex-wrap justify-content-start">
                                    ...
                                    <div class="col-12 col-md-2 form-group px-0 pl-md-2">
                                        ...
                                        <x-adminlte-select2 name="pipe_space" id="pipe_space">
                                            <option value="1"
                                                {{ old('pipe_space') == '1' || old('pipe_space') == 'true' ? 'selected' : ($client->pipe_space == '1' || $client->pipe_space == 'true' ? 'selected' : '') }}>
                                                Sim
                                            </option>
                                            <option value="0"
                                                {{ old('pipe_space') == '0' || old('pipe_space') == 'false' ? 'selected' : ($client->pipe_space == '0' || $client->pipe_space == 'false' ? 'selected' : '') }}>
                                                Não
                                            </option>
                                        </x-adminlte-select2>
                                    </div>
