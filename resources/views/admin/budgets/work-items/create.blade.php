...
@section('title', '- Cadastro de Item de Obra')
...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><i class="fas fa-fw fa-list-ol"></i> Novo Item de Obra</h1>
                </div>
                <div class="col-sm-6">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <form method="POST" action="{{ route('admin.work-items.store') }}">
                            @csrf
                            <div class="card-body">
                                ...
                                <div class="d-flex flex-wrap justify-content-start">
                                    <div class="col-12 col-md-2 form-group px-0 pr-md-2">
                                        ...
                                        <input type="text" class="form-control" id="code"
                                            placeholder="Código de Mão de Obra" name="code" value="{{ old('code') }}"
                                            required>
                                    </div>

                                    <div class="col-12 col-md-6 form-group px-0 px-md-2">
                                        <label for="description">Descrição</label>
                                        <input type="text" class="form-control" id="description" placeholder="Texto descritivo"
                                    ...
                                    <div class="col-12 col-md-2 form-group px-0 pr-md-2 mb-0">
                                        ...
                                        <x-adminlte-select2 name="unity">
                                            <option {{ old('unity') == 'UN' ? 'selected' : '' }} value="UN">
                                                UN
                                            </option>
                                            <option {{ old('unity') == 'Metro Linear' ? 'selected' : '' }}
                                                value="Metro Linear">
                                                Metro Linear
                                            </option>
                                            <option {{ old('unity') == 'KM' ? 'selected' : '' }} value="KM">
                                                KM
                                            </option>
                                        </x-adminlte-select2>
                                    </div>
                                ...
                                <div class="d-flex flex-wrap justify-content-start">
                                    <div class="col-12 col-md-6 form-group px-0 pr-md-2 mb-0">
                                        ...
                                        <x-adminlte-select2 name="category">
                                            <option {{ old('category') == 'Água' ? 'selected' : '' }} value="Água">
                                                Água
                                            </option>
                                            <option {{ old('category') == 'Gás' ? 'selected' : '' }}
                                                value="Gás">
                                                Gás
                                            </option>
                                            <option {{ old('category') == 'Geral' ? 'selected' : '' }} value="Geral">
                                                Geral
                                            </option>
                                            <option {{ old('category') == 'Hidrômetro' ? 'selected' : '' }} value="Hidrômetro">
                                                Hidrômetro
                                            </option>
                                            <option {{ old('category') == 'Sistema' ? 'selected' : '' }} value="Sistema">
                                                Sistema
                                            </option>
                                        </x-adminlte-select2>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-2 form-group px-0 px-md-2">
                                        ...
                                        <input type="text" class="form-control percentage" id="tax"
                                            placeholder="Valor em porcentagem" name="tax" value="{{ old('tax') }}"
                                            required>
                                    </div>
