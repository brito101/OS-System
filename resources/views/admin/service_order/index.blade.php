            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        @php
                            $heads = [['label' => 'ID', 'width' => 5], 'NS', 'Tipo', 'Atividade', 'Filial', 'Autor', 'Cliente', 'Endereço', 'Participante', 'Prioridade', 'Prazo', ['label' => 'Prazo_BR', 'no-export' => true], 'Status', 'Prontificação', ['label' => 'Prontificação_BR', 'no-export' => true], ['label' => 'Ações', 'no-export' => true, 'width' => 15]];
                            $config = [
                                'order' => [[0, 'desc']],
                                'ajax' => url('/admin/service-orders'),
                                'columns' => [['data' => 'id', 'name' => 'id'], ['data' => 'number_series', 'name' => 'number_series'], ['data' => 'type', 'name' => 'type'], ['data' => 'activity', 'name' => 'activity'], ['data' => 'subsidiary', 'name' => 'subsidiary'], ['data' => 'author', 'name' => 'author'], ['data' => 'client', 'name' => 'client'], ['data' => 'address', 'name' => 'address'], ['data' => 'collaborator', 'name' => 'collaborator'], ['data' => 'priority', 'name' => 'priority'], ['data' => 'deadline_pt', 'name' => 'deadline'], ['data' => 'deadline_pt', 'name' => 'deadline_pt', 'visible' => false], ['data' => 'status', 'name' => 'status'], ['data' => 'readiness_date_pt', 'name' => 'readiness_date'], ['data' => 'readiness_date_pt', 'name' => 'readiness_date_pt', 'visible' => false], ['data' => 'action', 'name' => 'action', 'orderable' => false, 'searchable' => false]],
