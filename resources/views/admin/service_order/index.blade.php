            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        @php
                            $heads = [['label' => 'ID', 'width' => 5], 'NS', 'Atividade', 'Autor', 'Cliente', 'Participante', 'Prioridade', 'Prazo', 'Status', 'Prontificação', ['label' => 'Ações', 'no-export' => true, 'width' => 15]];
                            $config = [
                                'order' => [[0, 'desc']],
                                'ajax' => url('/admin/service-orders'),
                                'columns' => [['data' => 'id', 'name' => 'id'], ['data' => 'number_series', 'name' => 'number_series'], ['data' => 'activity', 'name' => 'activity'], ['data' => 'author', 'name' => 'author'], ['data' => 'client', 'name' => 'client'], ['data' => 'collaborator', 'name' => 'collaborator'], ['data' => 'priority', 'name' => 'priority'], ['data' => 'deadline', 'name' => 'deadline'], ['data' => 'status', 'name' => 'status'], ['data' => 'readiness_date', 'name' => 'readiness_date'], ['data' => 'action', 'name' => 'action', 'orderable' => false, 'searchable' => false]],
