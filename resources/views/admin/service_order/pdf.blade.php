                ...
                <div class="d-flex flex-wrap justify-content-between">
                    @if ($serviceOrder->costumer_name)
                        <div class="col-6 form-group pr-2">
                            ...
                            <input type="text" class="form-control bg-white" id="costumer_name" name="costumer_name"
                                value="{{ $serviceOrder->costumer_name }}" disabled>
                        </div>
                    @endif
                    ...
                    @if ($serviceOrder->costumer_document)
                        <div class="col-6 form-group pl-2">
                            ...
                            <input type="text" class="form-control bg-white" id="costumer_document"
                                name="costumer_document" value="{{ $serviceOrder->costumer_document }}" disabled>
                        </div>
                    @endif
                </div>
