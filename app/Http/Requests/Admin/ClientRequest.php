...
class ClientRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'document_person' => "required|min:11|max:20|unique:clients,document_person,{$this->id},id,deleted_at,NULL",
            ...
            'company' => 'required|max:65000',
            'observations' => 'nullable|max:4000000000',
            'service' => 'nullable|max:65000',
            'type' => 'required|in:Administradora,Construtora,Síndico Profissional,Condomínio Comercial,Condomínio Residencial,Síndico Orgânico,Parceiro,Indicação,Outros',
